...
def load_gui(self):
    ...
    self.lbl_current_course = tk.Label(self.master,text='Current_Course: ')
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: student_func.ask_quit(self))
    self.btn_submit.grid(row=10,column=0,columnspan=1,padx=(15,0),pady=(45,10),sticky=W)

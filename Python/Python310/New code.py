...
name = 'Billy'
print(name)
print("Now it is time to print BILLY in all lower case letters: "
      + name.lower())
list_names = ['Billy', 'Sally', 'Johnny', 'Raphael']
print("Here's the list we created: ")
print(list_names)
print("Here's the third name from the list we wrote in all caps: "
      + list_names[2].upper())
date = "July/14th/1987"
...
print("Here's " + another_name + " written with the cases swapped: "
      +another_name.swapcase())

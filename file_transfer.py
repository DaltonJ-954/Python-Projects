...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        # for two years
        #date_in_2yrs = currently + timedelta(days = 730)
 
        # day = currently + timedelta(days = 1)
    ...
    # Create function to select a destination directory
    def destDir(self):
    ...
    def transferFiles(self):
        ...
        for i in source_files:
            ...
            editfile = datetime.datetime.fromtimestamp(modtime)
            print(editfile)
            
            day = datetime.datetime.now() - timedelta(hours = 24)
            if day < editfile:
